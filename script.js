...
const MARAGOGI_CARD_DEFAULTS = {
  ...
  "--maragogi-title-x": "-0.8%",
  "--maragogi-title-y": "54.6%",
  ...
  "--maragogi-wave-icon-x": "-0.2%",
  "--maragogi-wave-icon-y": "73.5%",
  "--maragogi-wave-icon-width": "15.8%",
  "--maragogi-wave-icon-height": "18%",
  "--maragogi-wave-text-x": "13.8%",
  "--maragogi-wave-text-y": "79.3%",
  "--maragogi-wave-text-width": "17%",
  "--maragogi-wave-text-font-size": "12px",
  "--maragogi-boat-icon-x": "30.4%",
  "--maragogi-boat-icon-y": "73.5%",
  "--maragogi-boat-icon-width": "14.6%",
  "--maragogi-boat-icon-height": "18%",
  "--maragogi-boat-text-x": "43.9%",
  "--maragogi-boat-text-y": "79.3%",
  "--maragogi-boat-text-width": "17%",
  "--maragogi-boat-text-font-size": "12px",
  "--maragogi-palm-icon-x": "64.6%",
  "--maragogi-palm-icon-y": "73.5%",
  "--maragogi-palm-icon-width": "10.6%",
  "--maragogi-palm-icon-height": "18%",
  "--maragogi-palm-text-x": "75.8%",
  "--maragogi-palm-text-y": "79.3%",
  "--maragogi-palm-text-width": "17%",
  "--maragogi-palm-text-font-size": "12px",
  "--maragogi-separator-1-x": "30.8%",
  "--maragogi-separator-1-y": "78.6%",
  "--maragogi-separator-1-width": "2.1px",
  "--maragogi-separator-1-height": "6.7%",
  "--maragogi-separator-1-opacity": "1",
  "--maragogi-separator-2-x": "63.5%",
  "--maragogi-separator-2-y": "78.6%",
  "--maragogi-separator-2-width": "2.1px",
  "--maragogi-separator-2-height": "6.7%",
