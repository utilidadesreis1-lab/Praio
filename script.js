...
const MARAGOGI_CARD_DEFAULTS = {
  ...
  "--maragogi-accent-y": "66.6%",
  "--maragogi-accent-width": "25%",
  "--maragogi-accent-height": "6.6%",
  "--maragogi-accent-scale": "1.37",
  "--maragogi-icons-scale": "1",
  "--maragogi-wave-icon-x": "-2.8%",
  "--maragogi-wave-icon-y": "75.1%",
  "--maragogi-wave-icon-width": "18%",
  "--maragogi-wave-icon-height": "15.1%",
  "--maragogi-wave-text-x": "12%",
  "--maragogi-wave-text-y": "79%",
  "--maragogi-wave-text-width": "16%",
  "--maragogi-wave-text-font-size": "14px",
  "--maragogi-boat-icon-x": "29.4%",
  "--maragogi-boat-icon-y": "74.1%",
  "--maragogi-boat-icon-width": "18%",
  "--maragogi-boat-icon-height": "18%",
  "--maragogi-boat-text-x": "45.3%",
  "--maragogi-boat-text-y": "79.5%",
  "--maragogi-boat-text-width": "20.6%",
  "--maragogi-boat-text-font-size": "14px",
  "--maragogi-palm-icon-x": "65.6%",
  "--maragogi-palm-icon-y": "73.6%",
  "--maragogi-palm-icon-width": "13.4%",
  "--maragogi-palm-icon-height": "18%",
  "--maragogi-palm-text-x": "78%",
  "--maragogi-palm-text-y": "79.5%",
  "--maragogi-palm-text-width": "17%",
  "--maragogi-palm-text-font-size": "14px",
  "--maragogi-separator-1-x": "31.4%",
  "--maragogi-separator-1-y": "77.6%",
  "--maragogi-separator-1-width": "2.1px",
  "--maragogi-separator-1-height": "8.7%",
  "--maragogi-separator-1-opacity": "0.5",
  "--maragogi-separator-2-x": "66.6%",
  "--maragogi-separator-2-y": "77.6%",
  "--maragogi-separator-2-width": "1.8px",
  "--maragogi-separator-2-height": "8.9%",
  "--maragogi-separator-2-opacity": "0.56",
