...
const IPIOCA_CARD_DEFAULTS = {
  ...
  "--ipioca-title-x": "27.3%",
  "--ipioca-title-y": "57.1%",
  "--ipioca-title-width": "41.6%",
  "--ipioca-title-height": "19.4%",
  "--ipioca-title-scale": "1.14",
  "--ipioca-title-shadow-x": "25.6%",
  "--ipioca-title-shadow-y": "58.3%",
  "--ipioca-title-shadow-width": "47%",
  "--ipioca-title-shadow-height": "14.6%",
  "--ipioca-title-shadow-opacity": "0.82",
  "--ipioca-title-shadow-blur": "16px",
  "--ipioca-title-shadow-radius": "28px",
  "--ipioca-accent-x": "33.8%",
  "--ipioca-accent-y": "69.4%",
  "--ipioca-accent-width": "21%",
  "--ipioca-accent-height": "5.1%",
  "--ipioca-accent-scale": "1.2",
  "--ipioca-icons-scale": "1.56",
  "--ipioca-wave-icon-x": "6.3%",
  "--ipioca-wave-icon-y": "75.3%",
  "--ipioca-wave-icon-width": "9.6%",
  "--ipioca-wave-icon-height": "14.4%",
  "--ipioca-wave-text-x": "18.2%",
  "--ipioca-wave-text-y": "80.4%",
  "--ipioca-wave-text-width": "13.8%",
  "--ipioca-wave-text-font-size": "9.8px",
  "--ipioca-boat-icon-x": "39.8%",
  "--ipioca-boat-icon-y": "75.7%",
  "--ipioca-boat-icon-width": "7.5%",
  "--ipioca-boat-icon-height": "13.1%",
  "--ipioca-boat-text-x": "50.4%",
  "--ipioca-boat-text-y": "80.1%",
  "--ipioca-boat-text-width": "10.5%",
  "--ipioca-boat-text-font-size": "10.7px",
  "--ipioca-palm-icon-x": "65.5%",
  "--ipioca-palm-icon-y": "74.9%",
  "--ipioca-palm-icon-width": "9.9%",
  "--ipioca-palm-icon-height": "14.4%",
  "--ipioca-palm-text-x": "77%",
  "--ipioca-palm-text-y": "80.1%",
  "--ipioca-palm-text-width": "14.1%",
  "--ipioca-palm-text-font-size": "10px",
  "--ipioca-separator-1-x": "35.8%",
  "--ipioca-separator-1-y": "79.8%",
  "--ipioca-separator-1-width": "2px",
  "--ipioca-separator-1-height": "5.2%",
  "--ipioca-separator-1-opacity": "1",
  "--ipioca-separator-2-x": "64.3%",
  "--ipioca-separator-2-y": "79.8%",
  "--ipioca-separator-2-width": "2px",
  "--ipioca-separator-2-height": "5.2%",
  "--ipioca-separator-2-opacity": "1",
  ...
  "--ipioca-overlay-bottom-start": "81%",
  "--ipioca-overlay-top-opacity": "0.47",
  "--ipioca-overlay-mid-opacity": "0",
  "--ipioca-overlay-bottom-opacity": "1"
};
